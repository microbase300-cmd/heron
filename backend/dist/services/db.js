...
exports.db = exports.PLANS = void 0;
...
class DatabaseService {
    ...
    save(dataToSave) {
        try {
            ...
            fs_1.default.writeFileSync(DB_FILE, JSON.stringify(d, null, 2), 'utf-8');
        }
        catch (err) {
    ...
    seedInitial() {
        ...
        const demoPasswordHash = bcryptjs_1.default.hashSync('Heron2026!', salt);
        const now = Date.now();
        const demoUser = {
            id: 'usr_demo_882194',
    ...
    // Referrals
    getReferralCommissionsByReferrerId(referrerId) {
