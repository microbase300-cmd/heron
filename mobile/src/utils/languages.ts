// ============================================================================
// GLOBAL LANGUAGES DATASET & TRANSLATIONS (100+ COUNTRIES & LANGUAGES)
// HERON ASSETS TRUSTEE • MOBILE APPLICATION
// ============================================================================
...
export const getLanguageByCode = (code: string): LanguageItem => {
  const found = ALL_LANGUAGES.find(l => l.code.toLowerCase() === (code || 'en').toLowerCase());
  return found || ALL_LANGUAGES[0];
};

export const searchLanguages = (query: string): LanguageItem[] => {
